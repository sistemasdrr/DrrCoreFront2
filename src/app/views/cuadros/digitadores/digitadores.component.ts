...
export class DigitadoresComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.comboService.getDigitadores().subscribe(
      (response) => {
        if(response.isSuccess === true){
          this.listaDigitadores = response.data
        }
      }
    )
  ...
  descargarDocumento(idQuery: number, format: string) {
    switch (idQuery) {
      ...
      case 1:
        this.loading = true;
        this.reportService
          .DownloadReport6_4_1(this.query1_1_startString, this.query1_1_endString,this.query1_1_code, format)
          .subscribe((response) => {
        ...
        this.loading = true;
        this.reportService
          .DownloadReport6_4_2(this.query1_2_code, format)
          .subscribe((response) => {
            const blob: Blob = response.body as Blob;
            const a = document.createElement('a');
            a.download =
        ...
        this.loading = true;
        this.reportService
          .DownloadReport6_4_3(this.query1_3_startString, this.query1_3_endString, this.query1_3_code, format)
          .subscribe((response) => {
            const blob: Blob = response.body as Blob;
            const a = document.createElement('a');
            a.download =
        ...
        this.loading = true;
        this.reportService
          .DownloadReport6_4_4(this.query1_4_month, this.query1_4_year, this.query1_4_orderBy, format)
          .subscribe((response) => {
            const blob: Blob = response.body as Blob;
            const a = document.createElement('a');
            a.download =
  ...
  listaDigitadores : ComboDataName[] = []
  ...
  selectQuery6_4_1(){
    this.loading = true
    this.reportService
    .DownloadReport6_4_1(this.query1_1_startString, this.query1_1_endString,this.query1_1_code, 'pdf')
          .subscribe((response) => {
  ...
  selectQuery6_4_2(){
    this.loading = true
    this.reportService
    .DownloadReport6_4_2(this.query1_2_code, 'pdf')
          .subscribe((response) => {
  ...
  selectQuery6_4_3(){
    this.loading = true
    this.reportService
    .DownloadReport6_4_3(this.query1_3_startString, this.query1_3_endString,this.query1_3_code, 'pdf')
    .subscribe((response) => {
  ...
  selectQuery6_4_4(){
    this.loading = true
    this.reportService
    .DownloadReport6_4_4(this.query1_4_month, this.query1_4_year,this.query1_4_orderBy, 'pdf')
    .subscribe((response) => {
